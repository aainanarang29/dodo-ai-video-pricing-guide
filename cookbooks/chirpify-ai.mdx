...
<Note>
  The billing address and customer email are hardcoded for demo purposes. In production:

  - Collect email through your auth/signup flow and pass it dynamically
  - Let Dodo's checkout page handle billing address collection
  - Pass authenticated user details instead of placeholder values
</Note>
...
<Frame caption="Handling the payment callback">
  <img src="https://link.excalidraw.com/readonly/chirpify-callback-flow" alt="Callback Flow" />
</Frame>
